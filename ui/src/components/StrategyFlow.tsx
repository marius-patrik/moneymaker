  ...
  const rawNodes: Node[] = [
    {
      ...
      type: "pipeline",
      position: { x: 0, y: 0 },
      data: { label: "DataProvider", sub: "yfinance / csv / alpaca", color: "bg-blue-950 border-blue-800" },
    },
    {
      id: "strategy",
      type: "pipeline",
      position: { x: 0, y: 0 },
      data: { label: strategyName, sub: paramSummary || "default params", color: "bg-violet-950 border-violet-700" },
    },
    {
      id: "risk",
      type: "pipeline",
      position: { x: 0, y: 0 },
      data: { label: "RiskManager", sub: "position sizing", color: "bg-amber-950 border-amber-700" },
    },
    {
      id: "provider",
      type: "pipeline",
      position: { x: 0, y: 0 },
      data: { label: "ExecProvider", sub: "simulated / broker", color: "bg-emerald-950 border-emerald-700" },
    },
    {
      id: "logger",
      type: "pipeline",
      position: { x: 0, y: 0 },
      data: { label: "TradeLogger", sub: "sessions/", color: "bg-rose-950 border-rose-800" },
    },
  ];
