...
POST /api/positions/<id>/close close a manual position
GET  /api/strategies/stats     per-strategy performance
POST /api/strategies/<n>/duplicate  copy a strategy so it can be edited
